...
| 8a. Тюнинг v2: русский system-prompt генерации, метки фрагментов по-русски; в eval — валюта считается утечкой только рядом с числом, мягкое покрытие фактов по основам слов | in progress | 2026-09-14 | на 14 худших: facts 0→32%, утечек 0, ~10 с/запрос; полный прогон v2 с LLM-judge (локальная Qwen3.8-27B) — `golden-v2-prompt.md` |
