...
def test_embedding_service_initialization():
    ...
    with patch('src.docarag.services.embeddings.EmbeddingGRPCClient') as mock_client_class:
        mock_client = Mock()
...
def test_embed_batch_empty(embedding_service, mock_grpc_client):
    ...
    mock_grpc_client.embed_batch.side_effect = ValueError("Cannot embed empty list of texts")
